...
class Classifier {
  ...
  void loadModel({Interpreter? interpreter}) async {
    try {
      ...
      var output = _interpreter?.getOutputTensors().first;
      var input = _interpreter?.getInputTensors().first;
      _outputShapes = [];
      _outputTypes = [];
  ...
  Map<String, dynamic>? predict(imageLib.Image image) {
    ...
    TensorBuffer test = TensorBufferFloat(_out!);
    ...
    logger.d(outputLocations.buffer);
    // 머신러닝 모델 실행
